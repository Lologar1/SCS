...
public class PrimitiveNOR extends ComponentHolder implements PrimitiveComponent {
    public PrimitiveNOR(int[] position, int wireSize, Rotation startingRotation) {
        super("NOR " + wireSize, position, 3, 1, wireSize, new int[]{0, 2}, new int[]{1}, startingRotation, null);

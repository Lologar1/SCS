...
public class PrimitiveOR extends ComponentHolder implements PrimitiveComponent{
    public PrimitiveOR(int[] position, int wireSize, Rotation startingRotation) {
        super("OR " + wireSize, position, 3, 1, wireSize, new int[]{0, 2}, new int[]{1}, startingRotation, null);

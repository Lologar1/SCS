...
public class PrimitiveNAND extends ComponentHolder implements PrimitiveComponent {
    public PrimitiveNAND(int[] position, int wireSize, Rotation startingRotation) {
        super("NAND " + wireSize, position, 3, 1, wireSize, new int[]{0, 2}, new int[]{1}, startingRotation, null);

...
public class PrimitiveXNOR extends ComponentHolder implements PrimitiveComponent {
    public PrimitiveXNOR(int[] position, int wireSize, Rotation startingRotation) {
        super("XNOR " + wireSize, position, 3, 1, wireSize, new int[]{0, 2}, new int[]{1}, startingRotation, null);

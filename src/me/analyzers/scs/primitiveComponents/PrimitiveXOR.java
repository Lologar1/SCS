...
public class PrimitiveXOR extends ComponentHolder implements PrimitiveComponent {
    public PrimitiveXOR(int[] position, int wireSize, Rotation startingRotation) {
        super("XOR " + wireSize, position, 3, 1, wireSize, new int[]{0, 2}, new int[]{1}, startingRotation, null);
